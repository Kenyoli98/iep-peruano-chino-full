...
const { registrarPension, listarPensiones, misPensiones, pagarPension } = require('../controllers/pensionController');
...
router.get('/mis-pensiones', verificarToken, permitirRoles('alumno'), misPensiones);
