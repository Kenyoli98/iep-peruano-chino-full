  ...
  try {
    ...
    for (const seccion of secciones) {
      try {
        ...
        if (existente) {
          console.log(
            `⚠️  Ya existe: ${seccion.nombre} - ${seccion.nivel} ${seccion.grado}°`
          );
          duplicadas++;
          continue;
        }
        ...
        console.log(
          `✅ Creada: ${seccion.nombre} - ${seccion.nivel} ${seccion.grado}°`
        );
        creadas++;
      } catch (error) {
        console.error(
          `❌ Error creando ${seccion.nombre} - ${seccion.nivel} ${seccion.grado}°:`,
          error.message
        );
        errores++;
      }
