...
async function eliminarAsignacionSeccionE() {
  try {
    console.log('🔍 Buscando la asignación que bloquea la eliminación de la sección E...');
    ...
    console.log(`   Profesor: ${asignacion.profesor.nombre} ${asignacion.profesor.apellido}`);
