...
import { filtrarCursos, validarArchivoCsv, manejarErrorApi } from '@/utils/cursos';
...
const CursosAdminPage = () => {
  ...
  const handleBuscar = () => {
    ...
    if (cursosEncontrados.length === 0 && filtros.nombre.trim()) {
      toast.error(`No se encontraron cursos que coincidan con "${filtros.nombre}"`);
  ...
  if (isAuthenticated === null || (loading && cursos.length === 0)) {
    return (
      <div className={`min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 ${styles.cursosContainer}`}>
      ...
      <div className={`min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 ${styles.cursosContainer}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Error al cargar cursos</h3>
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 ${styles.cursosContainer}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Header */}
        <div className={`${styles.headerGradient} bg-blue-500 rounded-2xl p-8 mb-8 text-white relative overflow-hidden`}>
          <div className="relative z-10">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div className="mb-6 md:mb-0">
                <h1 className="text-3xl md:text-4xl font-bold mb-2">Gestión de Cursos</h1>
                <p className="text-slate-100 text-lg">Administra el catálogo académico de la institución</p>
                <div className="flex items-center mt-4 space-x-6">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium">{cursos.length} Cursos Registrados</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center mr-2">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
