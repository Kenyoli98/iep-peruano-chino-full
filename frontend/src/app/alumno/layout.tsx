...
import { FaSignOutAlt, FaUser, FaMoneyBillWave, FaClipboardList, FaCalendarAlt } from 'react-icons/fa';
...
export default function AlumnoLayout({
  ...
  useAuth(['alumno']); // 🔒 Solo permite acceso a rol "alumno"
