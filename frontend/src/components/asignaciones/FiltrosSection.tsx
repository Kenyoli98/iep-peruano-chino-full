        ...
        <div className="flex items-center space-x-6 text-sm">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-600">
              Mostrando <span className="font-semibold text-gray-900">{profesoresFiltrados}</span> de{' '}
              <span className="font-semibold text-gray-900">{totalProfesores}</span> profesores
            </span>
          </div>
        </div>
      </div>
