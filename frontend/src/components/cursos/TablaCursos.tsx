  ...
  <div className="bg-gradient-to-br from-white via-slate-50/50 to-white rounded-xl shadow-xl border border-slate-200/60 overflow-hidden backdrop-blur-sm">
    <div className="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-b border-gray-200">
      <div className="flex items-center">
        ...
        <h3 className="text-lg font-semibold text-gray-800">Catálogo de Cursos Académicos</h3>
      ...
      <table className="min-w-full divide-y divide-slate-200/60">
        ...
        <tbody className="bg-white/80 divide-y divide-slate-200/40">
          {cursos.map((curso, index) => (
            <tr key={curso.id} className="hover:bg-gradient-to-r hover:from-blue-50/30 hover:to-indigo-50/30 transition-all duration-300 hover:shadow-sm group">
