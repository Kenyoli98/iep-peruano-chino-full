...
import { ModalCsvProps } from '@/types/cursos';
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg transform transition-all duration-300 scale-100">
        <div className="p-6">
          <div className="flex items-center mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Importar Cursos desde CSV</h2>
              <p className="text-sm text-gray-600">Carga masiva de cursos académicos</p>
            </div>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
                ...
                {archivo && (
                  <div className="mt-2 p-3 bg-green-50 border border-green-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium text-green-800">{archivo.name}</span>
                      <span className="text-xs text-green-600 ml-2">({(archivo.size / 1024).toFixed(1)} KB)</span>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm font-medium text-blue-800 mb-2">Formato Requerido del Archivo CSV</p>
                  <div className="text-xs text-blue-700 space-y-1">
                    <p><strong>Columnas obligatorias:</strong> nombre, descripcion (opcional)</p>
                    <p><strong>Separador:</strong> Coma (,)</p>
                    <p><strong>Codificación:</strong> UTF-8</p>
                    <p><strong>Primera fila:</strong> Encabezados de columnas</p>
                  </div>
                  <div className="mt-3 p-2 bg-blue-100 rounded text-xs text-blue-800 font-mono">
                    <strong>Ejemplo:</strong><br/>
                    nombre,descripcion<br/>
                    MATEMÁTICAS,Curso de matemáticas básicas<br/>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700">
                    Los cursos duplicados serán omitidos. Verifica que el formato sea correcto antes de importar.
                  </p>
                </div>
              </div>
            </div>
