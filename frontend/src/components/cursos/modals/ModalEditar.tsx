        ...
        <div className="p-6">
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Modifica la información del curso académico</p>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    value={curso.nombre}
                    onChange={(e) => setCurso({ ...curso, nombre: e.target.value.toUpperCase() })}
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Modifica el nombre completo de la materia o curso académico (2-100 caracteres)
                </p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700">
                    Los cambios afectarán todas las secciones, asignaciones y registros asociados a este curso.
                  </p>
                </div>
              </div>
            </div>
