  ...
  const contactMethods = [
    {
      icon: '📞',
      title: 'Llámanos',
      description: 'Habla directamente con nuestro equipo de admisiones para resolver todas tus dudas.',
    ...
    },
    {
      icon: '📍',
      title: 'Visítanos',
      description: 'Ven a conocer nuestras instalaciones y vive la experiencia educativa.',
    ...
    <section className="relative py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Da el primer paso hacia un futuro brillante. Contáctanos hoy y descubre cómo podemos transformar la educación de tu hijo.
          </p>
        </div>
        ...
        <div className="mt-12 animate-fade-in" style={{ animationDelay: '1.2s' }}>
          <p className="text-gray-600 text-lg">
            <span className="font-semibold text-blue-900">Becas disponibles:</span> Consulta por nuestros programas de apoyo educativo
          </p>
        </div>
      </div>
    </section>
