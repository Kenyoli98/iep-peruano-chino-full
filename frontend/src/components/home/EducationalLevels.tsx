...
const LevelCard = ({ 
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        <div className="mb-4">
          <h3 className="text-xl font-bold text-blue-900 mb-1">{level.title}</h3>
          <p className="text-blue-600 font-semibold text-sm">{level.subtitle}</p>
        </div>
        ...
        <div className="space-y-2 mb-6">
          {level.features.map((feature, featureIndex) => (
            <div key={featureIndex} className="flex items-center space-x-2 text-gray-700">
  ...
  const levels: EducationalLevel[] = [
    {
      ...
      description: 'Desarrollamos las habilidades fundamentales a través de metodologías innovadoras y un ambiente seguro de aprendizaje.',
      features: [
    ...
    },
    {
      ...
      description: 'Fortalecemos las competencias académicas fundamentales mientras fomentamos la curiosidad y el pensamiento crítico.',
      features: [
    ...
    },
    {
      ...
      description: 'Desarrollamos competencias avanzadas y preparamos a nuestros estudiantes para la educación superior y la vida profesional.',
      features: [
      ...
      <div className="container mx-auto px-6">
        ...
        <div className={`text-center mb-12 transition-all duration-1000 ${
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Descubre nuestros programas educativos diseñados para cada etapa del desarrollo. 
            Cada nivel está cuidadosamente estructurado para maximizar el potencial de aprendizaje.
          </p>
        </div>
        ...
        <div className={`text-center transition-all duration-1000 delay-1000 ${
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Únete a nuestra comunidad educativa y descubre el potencial de nuestros estudiantes.
            </p>
