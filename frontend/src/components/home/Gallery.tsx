...
import { FaExpand, FaTimes, FaChevronLeft, FaChevronRight, FaCalendarAlt, FaUsers } from 'react-icons/fa';
...
const GalleryItemCard = ({ item, index, onOpenLightbox }: {
  item: GalleryItem;
  index: number;
  ...
  const getCategoryStyle = (category: string) => {
    switch (category) {
      case 'facilities': return 'bg-blue-100 text-blue-600';
      ...
      <div className="p-6">
        ...
        <div className="mt-4 flex items-center justify-between">
          <span className={`px-3 py-1 rounded-full text-xs font-medium ${getCategoryStyle(item.category)}`}>
            {item.category === 'facilities' ? 'Instalaciones' :
             item.category === 'activities' ? 'Actividades' : 'Eventos'}
          </span>
        </div>
      </div>
    </div>
...
const Lightbox = ({ selectedImage, currentImageIndex, filteredItems, onClose, onNext, onPrev }: {
...
const CTASection = () => {
  ...
  return (
    ...
    >
      <h3 className={`text-2xl md:text-3xl font-bold mb-4 transition-all duration-1000 delay-200 ${
        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
      }`}>
        ¿Te gustaría conocer nuestras instalaciones?
      </h3>
      <p className={`text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed transition-all duration-1000 delay-300 ${
        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
      }`}>
  ...
  const galleryItems = [
    {
      ...
      description: 'Moderno laboratorio equipado con tecnología de vanguardia para experimentos científicos.'
    },
    {
      id: 2,
      ...
      description: 'Amplia biblioteca con más de 10,000 libros y espacios de estudio colaborativo.'
    },
    {
      id: 3,
      ...
      description: 'Sala de cómputo con equipos modernos para el aprendizaje digital.'
    },
    {
      id: 4,
      ...
      category: 'events',
      image: '/images/imagen-login1.jpg',
      description: 'Evento anual donde los estudiantes muestran sus habilidades artísticas.'
    },
    {
      id: 5,
      title: 'Clase de Arte',
      category: 'activities',
      image: '/images/imagen-login2.jpg',
      description: 'Estudiantes desarrollando su creatividad en el taller de artes plásticas.'
    },
    {
      id: 6,
      ...
      category: 'activities',
      image: '/images/imagen-login3.jpg',
      description: 'Actividades deportivas que promueven el trabajo en equipo y la vida saludable.'
    },
    {
      id: 7,
      ...
      category: 'events',
      image: '/images/imagen-login1.jpg',
      description: 'Momento especial de celebración del logro académico de nuestros estudiantes.'
    },
    {
      id: 8,
      ...
      category: 'facilities',
      image: '/images/imagen-login2.jpg',
      description: 'Espacio especializado para el aprendizaje de idiomas extranjeros.'
    },
    {
      id: 9,
      ...
      category: 'activities',
      image: '/images/imagen-login3.jpg',
      description: 'Estudiantes trabajando en proyectos de investigación científica.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Explora nuestros modernos espacios educativos, actividades estudiantiles y 
            los momentos más especiales de nuestra comunidad académica.
          </p>
        </div>
