  ...
  const values: Value[] = [
    {
      icon: '🤝',
      title: 'Respeto',
      description: 'Valoramos la diversidad y promovemos un ambiente de respeto mutuo en nuestra comunidad educativa.'
    },
    {
      icon: '⭐',
      title: 'Excelencia',
      description: 'Buscamos la calidad en todos nuestros procesos educativos y administrativos.'
    },
    {
      icon: '🎯',
      title: 'Compromiso',
      description: 'Nos dedicamos con responsabilidad al desarrollo integral de nuestros estudiantes.'
    },
    {
      icon: '💡',
      title: 'Innovación',
      description: 'Implementamos metodologías modernas y tecnología educativa de vanguardia.'
    },
    {
      icon: '🌟',
      title: 'Integridad',
      description: 'Actuamos con transparencia, honestidad y ética en todas nuestras acciones.'
    },
    {
      icon: '❤️',
      title: 'Vocación de Servicio',
      description: 'Servimos con pasión y dedicación a la formación de las futuras generaciones.'
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Los principios fundamentales que guían nuestra institución educativa hacia la excelencia académica y la formación integral.
          </p>
        </div>
        ...
        >
          {/* Mission */}
          <div className={`bg-blue-50 rounded-lg p-8 transition-all duration-1000 ${
          ...
          style={{ transitionDelay: '200ms' }}>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              críticos y comprometidos con su desarrollo personal y social, preparándolos 
              para los desafíos del futuro.
            </p>
          </div>

          {/* Vision */}
          <div className={`bg-gray-50 rounded-lg p-8 transition-all duration-1000 ${
            missionVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
          }`}
          style={{ transitionDelay: '400ms' }}>
            ...
            <p className="text-gray-700 leading-relaxed">
              Ser una institución educativa líder y reconocida por su excelencia académica, 
              innovación pedagógica y formación de ciudadanos íntegros que contribuyan 
        ...
        <div className={`text-center transition-all duration-1000 delay-1000 ${
          ...
          <div className="bg-blue-50 rounded-lg p-8">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Descubre todo lo que nuestra institución puede ofrecer para el desarrollo integral de nuestros estudiantes.
            </p>
