...
const TestimonialCard = ({ 
  ...
  <div className={`bg-white rounded-lg shadow-lg p-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      content: 'Esta institución ha transformado completamente la vida de mi hijo. Los profesores son magos de la educación que despiertan la pasión por aprender.',
      rating: 5,
      emoji: '🌟',
    ...
    },
    {
      ...
      role: 'Ex Alumno 🎓',
      content: 'Los valores cósmicos que aprendí aquí me han llevado a conquistar el universo profesional. ¡Eternamente agradecido por esta experiencia épica!',
      rating: 5,
      emoji: '🚀',
    ...
    },
    {
      ...
      content: 'Trabajar aquí es como ser parte de una constelación educativa. Cada día brillamos más fuerte iluminando el futuro de nuestros estudiantes.',
      rating: 5,
      emoji: '💫',
    ...
    },
    {
      ...
      content: 'Mi hija ha florecido como una supernova en este ambiente mágico. La atención personalizada es simplemente extraordinaria.',
      rating: 5,
      emoji: '🌺',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
            Descubre las experiencias transformadoras de padres y estudiantes que han confiado en nuestra educación integral
          </p>
        </div>
        ...
        <div className="bg-white/10 border border-white/20 rounded-xl p-12 text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-8">
            ...
            <p className="text-xl text-blue-100 mb-12 max-w-3xl mx-auto">
              Únete a nuestra institución educativa donde cada estudiante desarrolla su máximo potencial.
            </p>
