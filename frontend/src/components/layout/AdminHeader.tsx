...
export default function AdminHeader({ nombre, showUserMenu, toggleUserMenu, handleLogout }: Props) {
  return (
      ...
      <div className="flex items-center justify-between px-6 py-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col justify-center">
            <span className="font-bold text-xl text-slate-800 tracking-tight">I.E.P Peruano Chino</span>
            <span className="text-xs text-slate-500 font-medium">Panel de Administración</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="relative p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors duration-200">
            <FaBell size={18} />
            <span className="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center font-medium">3</span>
          </button>
