      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg transform transition-all duration-300 scale-100">
        <div className="p-6">
          <div className="flex items-center mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Importar Secciones desde CSV</h2>
              <p className="text-sm text-gray-600">Carga masiva de secciones académicas</p>
            </div>
          </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="text-xs text-blue-700 space-y-1">
                    <p><strong>Columnas obligatorias:</strong> nombre, nivel, grado</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700">
                    Las secciones duplicadas serán omitidas. Verifica que el formato sea correcto antes de importar.
                  </p>
                </div>
              </div>
            </div>
