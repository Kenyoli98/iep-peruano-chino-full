      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg transform transition-all duration-300 scale-100">
        <div className="p-6">
          <div className="flex items-center mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Editar Sección</h2>
              <p className="text-sm text-gray-600">Modifica la información de la sección académica</p>
            </div>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setSeccion({ ...seccion, nombre: e.target.value.toUpperCase() })}
              ...
              <div>
                ...
                <select
                  value={seccion.nivel}
                  onChange={(e) => setSeccion({ ...seccion, nivel: e.target.value })}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={seccion.grado}
                  onChange={(e) => setSeccion({ ...seccion, grado: e.target.value.toUpperCase() })}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm font-medium text-blue-800 mb-1">Atención</p>
                  <p className="text-xs text-blue-700">
                    Los cambios afectarán todos los estudiantes, asignaciones y registros asociados a esta sección.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              ...
              <button
                type="submit"
                disabled={loading || !seccion.nombre.trim() || !seccion.nivel || !seccion.grado.trim()}
                className={`flex-1 inline-flex items-center justify-center px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 ${
                  seccion.nombre.trim() && seccion.nivel && seccion.grado.trim() && !loading
