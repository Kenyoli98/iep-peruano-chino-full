...
import { ModalEliminarProps } from '@/types/secciones';
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="text-sm font-medium text-red-800 mb-1">
                  Sección a eliminar: <span className="font-bold">&quot;{seccion.grado} {seccion.nombre} - {seccion.nivel}&quot;</span>
                </p>
                <p className="text-xs text-red-700">
                  Se eliminarán todos los datos asociados incluyendo estudiantes, asignaciones y registros académicos.
                </p>
              </div>
            </div>
          </div>
