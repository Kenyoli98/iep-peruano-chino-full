  ...
  const filteredOptions =
    query === ''
      ...
      : options.filter((option) => {
          const searchStr = `${option.label} ${option.description || ''}`.toLowerCase();
        ...
        <div>
          ...
          <div className="relative">
            <HeadlessCombobox.Input
              ...
              displayValue={(id: unknown) => options.find(option => option.id.toString() === id)?.label || ''}
                        ...
                        {({ selected, active }) => (
                          <>
                            <div className="flex flex-col">
                              ...
                              {option.description && (
                                <span className={`text-sm truncate mt-0.5 ${
